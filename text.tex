...
\usepackage[latex=-shell-escape,cleanup={}]{auto-pst-pdf} % uncomment this if used with pdflatex
...
\newcommand{\curl}[1]{\href{#1}{\textless #1\textgreater}}
...
%Poměrně brzo po vydání MultiROM se na serveru Youtube začaly objevovat videa podrobně popisují jak se MultiROM používá.
...
\newpage
\section*{PŘÍLOHA E:}
\addcontentsline{toc}{section}{PŘÍLOHA E: Odkazy}
\printbibliography
