...
Aplikace je zdrama dostupná v obchodě Google Play, kde má velmi pozitivní hodnocení (4,7 z 5 hvězdiček k 11.\,3.\,2014).
...
\noindent \It{Obrázky z aplikace jsou kvůli velikosti zařazeny v příloze \attref{obrazky}.}
...
Nejčastějším způsobem je tzv. \B{dual-boot kernel}, který spočívá v upravení \It{init} skriptů a~používání některé z~volných oddílů na zařízení pro umístění druhé ROM (například |/cache|). Do druhého systému se uživatel nabootuje, pokud bude držet některou z~kláves na zařízení, např. snížení hlasitosti. Nevýhody této metody jsou možnost instalace pouze dvou systémů, které navíc musí být jen Android ROM. Dále používá pro obě ROM stejné jádro, které tedy musí být s~oběma kompatibilní. To může být často problém, na většině zařízení existují 2 a~více základních druhů ROM, které mezi sebou nejsou kompatibilní.
...
\caption{Boot manager: obrazovka \uv{ostatní možnosti}}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
 \includegraphics[height=\textheight-40]{img/app_main.png}
...
\begin{figure}[H]
\begin{center}
 \includegraphics[height=\textheight-40]{img/app_install.png}
...
\begin{figure}[H]
\begin{center}
 \includegraphics[height=\textheight-40]{img/app_roms.png}
\caption{Android aplikace: správa nainstalovaných systémů}
\end{center}
\end{figure}

% FIXME: musí být před posledním obrázkem, poslední obrázek \textheight+30, ostatní \textheight-40
\addtolength{\textheight}{-70pt}

\begin{figure}[H]
\begin{center}
 \includegraphics[height=\textheight+30]{img/app_widget.png}
